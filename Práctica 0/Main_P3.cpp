...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::translate(view, glm::vec3(0.0f,0.0f,-15.0f)); // CAMARA Con el ultimo argumento alejamos y acercamos la vista (camara)
		...
		//view = glm::translate( view, glm::vec3( screenWidth / 2, screenHeight / 2, -100.0f ) ); // use with orthographic projection, el ultimo argumento es el movimiento de la vista
